...
RAW_URL = "https://raw.githubusercontent.com/Klavis-AI/klavis/refs/heads/main/mcp_servers/discord/server.py"

OUTPUT_DIR = "result_json"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "discord_tools.json")
...
pattern = re.compile(
    r'types\.Tool\(\s*[^)]*?name\s*=\s*["\']([^"\']+)["\']\s*,\s*description\s*=\s*["\']([^"\']+)["\']',
    re.DOTALL
)
