...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "browser_tools.json")

RAW_URL = "https://raw.githubusercontent.com/bytedance/UI-TARS-desktop/refs/heads/main/packages/agent-infra/mcp-servers/browser/README.md"
