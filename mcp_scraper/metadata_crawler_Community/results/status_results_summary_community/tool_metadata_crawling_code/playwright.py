...
RAW_URL = "https://raw.githubusercontent.com/executeautomation/mcp-playwright/refs/heads/main/src/tools.ts"
...
object_pattern = re.compile(r'\{[^{}]*?name\s*:\s*["\']([^"\']+)["\'][^{}]*?description\s*:\s*["\']([^"\']+)["\']', re.DOTALL)

matches = object_pattern.findall(source)
