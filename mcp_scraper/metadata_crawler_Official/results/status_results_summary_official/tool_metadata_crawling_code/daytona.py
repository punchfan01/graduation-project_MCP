...
OWNER = "daytonaio"
REPO = "daytona"
TARGET_PATH = "apps/cli/mcp/tools"
OUTPUT_DIR = "result_json"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "daytona_tools.json")

re_name = re.compile(r'mcp\.NewTool\s*\(\s*"([^"]+)"')
re_desc = re.compile(r'mcp\.WithDescription\s*\(\s*"([^"]+)"')
