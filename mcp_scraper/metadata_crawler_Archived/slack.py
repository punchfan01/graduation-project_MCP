...
RAW_URL = "https://api.github.com/repos/modelcontextprotocol/servers-archived/contents/src/slack/index.ts"


OUTPUT_DIR = "result_json"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "slack_tools.json")
...
print(f"{len(results)}개의 Slack Tool 추출됨")